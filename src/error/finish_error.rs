...
use crate::{
    Progress,
    error::{CompletionError, TerminalError},
};

/// Failure from checked finish, with recovery when no terminal was attempted.
pub enum FinishError<'reporter> {
...
impl<'reporter> FinishError<'reporter> {
...
impl fmt::Display for FinishError<'_> {
